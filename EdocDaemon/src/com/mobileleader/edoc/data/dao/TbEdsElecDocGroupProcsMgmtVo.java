...
/**
 * 전자문서그룹처리관리 테이블의 레코드 정보를 저장하는 Value Object
 * 
 * @author inzi
 * @version 1.0
 * @since 2017.09.25
...
public class TbEdsElecDocGroupProcsMgmtVo {
	...
	//공전소 처리 여부
	private String sipprocessstatus   = "NONE";
	...
	public void setCrtnTimeString(String crtnTime) throws ParseException, java.text.ParseException {
		if (!crtnTime.equals("") && crtnTime != null) {
			SimpleDateFormat timeFormat = new SimpleDateFormat("yyyyMMddHHmmss");
	...
	public void setProcsStepStTimeString(String procsStepStTime) throws ParseException, java.text.ParseException {
		if (!procsStepStTime.equals("") && procsStepStTime != null) {
			SimpleDateFormat timeFormat = new SimpleDateFormat("yyyyMMddHHmmss");
	...
	public void setProcsStepEdTimeString(String procsStepEdTime) throws ParseException, java.text.ParseException {
		if (!procsStepEdTime.equals("") && procsStepEdTime != null) {
			SimpleDateFormat timeFormat = new SimpleDateFormat("yyyyMMddHHmmss");
	...
	public String getSipprocessstatus() {
		return sipprocessstatus;
	}

	public void setSipprocessstatus(String sipprocessstatus) {
		this.sipprocessstatus = sipprocessstatus;
	}
	...
	public String toString() {
		...
		sb.append("TbEdsElecDocGroupProcsMgmtVo [\n");
